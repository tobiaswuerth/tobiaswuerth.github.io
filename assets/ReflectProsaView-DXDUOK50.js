import{B as C,b as f,e as u,m as S,A as I,C as R,d as T,D as A,g as D,o as E,a as F,r as H,c as _,f as i,i as P,t as c,F as U,j,E as M,w as g,s as N,l as L,G as O,x as Y,_ as q}from"./main-D7NUvrPd.js";import{u as G}from"./useClipboard-C8K-nsI8.js";var K=`
    .p-textarea {
        font-family: inherit;
...
${$.icon} ${d}`}),p+=`
`)}),p.trim()}),w=_(()=>r.value.some(o=>o.trim())),V=()=>{s(z.value,e("clipboard.success"),e("clipboard.prosaSuccess"))};return(o,h)=>{const x=B,y=O,p=Y,$=N;return u(),f("div",null,[i("div",null,[i("p",null,c(o.$t("reflectProsa.description")),1),i("p",ne,[i("small",re,c(o.$t("reflectProsa.disclaimer")),1)])]),i("div",oe,[(u(!0),f(U,null,j(k.value,(b,l)=>(u(),L(y,{variant:"on",key:l},{default:g(()=>[P(x,{id:`input-${l}`,modelValue:r.value[l],"onUpdate:modelValue":d=>r.value[l]=d,rows:"3",autoResize:""},null,8,["id","modelValue","onUpdate:modelValue"]),i("label",{for:`input-${l}`},c(b.icon+" "+b.name),9,ie)]),_:2},1024))),128))]),P($,{class:"reflect-prosa-result"},M({title:g(()=>[h[0]||(h[0]=i("i",{class:"pi pi-eye",style:{"margin-right":".5rem"}},null,-1)),i("span",null,c(o.$t("reflectProsa.overview")),1)]),content:g(()=>[w.value?(u(),f("div",se,[i("pre",le,c(z.value),1)])):(u(),f("div",de,[i("i",null,c(o.$t("reflectProsa.noThoughts")),1)]))]),_:2},[w.value?{name:"footer",fn:g(()=>[P(p,{id:"copyBtn",onClick:V,icon:"pi pi-copy",label:o.$t("reflectProsa.copy")},null,8,["label"])]),key:"0"}:void 0]),1024)])}}}),fe=q(ce,[["__scopeId","data-v-7249b89b"]]);export{fe as default};
